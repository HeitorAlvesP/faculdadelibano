        ...
        <div className="md:hidden flex flex-col bg-[#f6f6f6] w-full relative z-20">
          ...
          <div className={`bg-[#f6f6f6] shadow-lg absolute top-full left-0 right-0 overflow-hidden transition-all duration-300 ${isMobileMenuOpen ? 'max-h-[300px]' : 'max-h-0'}`}>
            <ul className="text-[#0B1933] font-medium py-2 px-4">
              <li className="py-4 px-4 border-b border-gray-200/50"><Link href="#courses" onClick={() => setIsMobileMenuOpen(false)} className="block w-full text-left">Nossas Pós e MBA's</Link></li>
              <li className="py-4 px-4 border-b border-gray-200/50"><Link href="#contato" onClick={() => setIsMobileMenuOpen(false)} className="block w-full text-left">Contato</Link></li>
              <li className="py-4 px-4 border-b border-gray-200/50"><Link href="https://portal.faculdadelibano.edu.br/login" onClick={() => setIsMobileMenuOpen(false)} className="block w-full text-left">Já sou aluno</Link></li>
              <li className="py-4 px-4"><Link href="https://faculdadelibano.com.br/matricula/dados-iniciais" onClick={() => setIsMobileMenuOpen(false)} className="block w-full text-left">Matricule-se</Link></li>
            </ul>
          </div>
        </div>
